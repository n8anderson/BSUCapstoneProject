...
const habitatInfo = {
  ...
  desert: {
    ...
    citaion: 'https://earthobservatory.nasa.gov/biome/biodesert.php'
  },
  rainforest: {
  ...
  swamp: {
    name: 'Swamp',
    bodyText: 'Found everywhere around the world swamps are land that is either covered or saturated in water. Depending on the location of the swamp determines what type of water is present, if on a coastal region in saltwater will be present, but if it is inland then there will be freshwater.',
    citation: 'google.com'
  },
  grassland: {
    name: 'Grassland',
